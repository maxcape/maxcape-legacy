<?php
    ...
    function printBadges($skills, $experience, $levels)
    {
        ...
        //Naturalist
        $natLow = min(array($stl['Cooking'], $stl['Farming'], $stl['Herblore'], $stl['Runecrafting']));
        if ($natLow == 99) {
            ?>
        ...
        //F2P Maxed
        $f2pLow = min(array($stl['Attack'], $stl['Defence'], $stl['Strength'], $stl['Constitution'], $stl['Ranged'], $stl['Prayer'], $stl['Magic'], $stl['Cooking'], $stl['Woodcutting'], $stl['Fishing'], $stl['Firemaking'], $stl['Crafting'], $stl['Smithing'], $stl['Mining'], $stl['Dungeoneering'], $stl['Runecrafting']));
        ...
        if ($stl['Fishing'] >= 90 && $stl['Slayer'] >= 90 &&
            $stl['Runecrafting'] >= 90 && $stl['Herblore'] >= 90 &&
        ...
        $skillavg = (($stl['Crafting'] + $stl['Mining'] + $stl['Smithing'] + $stl['Fishing'] + $stl['Cooking'] + $stl['Firemaking'] + $stl['Woodcutting']
                + $stl['Runecrafting'] + $stl['Dungeoneering'] + $stl['Agility'] + $stl['Herblore'] + $stl['Thieving'] + $stl['Fletching'] + $stl['Slayer']
