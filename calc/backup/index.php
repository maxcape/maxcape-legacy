<?php
    ...
    if ( isset( $username ) && $username != "" ) {
        ...
        $response = $data[ 0 ];
        $data     = $data[ 1 ];
        if ( $response != "updated" && $response != "cached" && $response != "outdated" ) {
            ...
            <html>
                <head>
                    ...
                    <script type="text/javascript">
                        var skills = ['Attack', 'Defence', 'Strength', 'Constitution', 'Ranged', 'Prayer', 'Magic', 'Cooking', 'Woodcutting', 'Fletching', 'Fishing', 'Firemaking', 'Crafting', 'Smithing', 'Mining', 'Herblore', 'Agility', 'Thieving', 'Slayer', 'Farming', 'Runecraft', 'Hunter', 'Construction', 'Summoning', 'Dungeoneering', 'Divination'];
                        var g;
