<?php
    $trimmed = $dbf->getAllAssocResults("SELECT * FROM requirements WHERE CapeType=2");
?>
<div class="innercontent" id="trimmed">
    <form id="trim">
        <div id="requirementscontainer">
            <?php
                foreach ($trimmed as $req) {
                    $reqid = $req['RequirementID'];
                    $subrequirements = $dbf->getAllAssocResults("SELECT s.SubrequirementID, s.Text, s.Number, IFNULL(u.Value, 0) Value
